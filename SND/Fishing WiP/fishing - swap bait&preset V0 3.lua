...
local config = {
    ...
    bait_main = "Mayfly",         -- Bait for main trigger
    preset_main = "Placeholder1",   -- Preset for main trigger
    bait_reset = "Leech",       -- Bait for reset action
    preset_reset = "Placeholder2" -- Preset for reset action
}
